...
public partial class CryController : CharacterBody3D
{
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        Vector3 forwards = this.Camera.GlobalTransform.Basis.Z * inputDirection.Z;
        Vector3 right = this.Camera.GlobalTransform.Basis.X * inputDirection.X;
